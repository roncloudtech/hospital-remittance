        ...
        <main className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div className="bg-white p-6 rounded-lg shadow-sm border border-green-100">
              ...
              <p className="text-2xl font-bold mt-2">₦{totalFunds.toLocaleString()}</p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-green-100">
              ...
              <p className="text-2xl font-bold mt-2">₦{recentFunds.toLocaleString()}</p>
              <span className="text-sm text-green-600">Last 7 days</span>
            </div>
            <NavLink to={user.role === "admin" ? "/pending-approvals" : "/dashboard"}>
              <div className="bg-white p-6 rounded-lg shadow-sm border border-green-100">
                <h3 className="text-lg font-medium text-green-900">Pending Approvals</h3>
                <p className="text-2xl font-bold mt-2">{pendingCount} Requests</p>
                <span className="text-sm text-green-600">{pendingCount > 1 ? "Multiple Pending" : "1 Request"}</span>
              </div>
            </NavLink>
          </div>
